...
bl_info = {
    ...
    "author": "Baltram, HerrNamenlos123",
    "version": (1, 0),
    "blender": (4, 0, 0),
...
class Import3DB(bpy.types.Operator, ImportHelper):
    ...
    def execute(self, context):
        ...
        return import_3db.load(self, context, self.filepath, 0.01, self.diffuseOnly)


class Export3DB(bpy.types.Operator, ExportHelper):
    ...
    def execute(self, context):
        ...
        return export_3db.save(self, context, self.filepath, 100, self.useSelection)


def menu_func_export(self, context):
    self.layout.operator(Export3DB.bl_idname, text="Baltram's 3D format (.3db)")
...
def register():
    ...
    bpy.utils.register_class(Export3DB)
...
def unregister():
    ...
    bpy.utils.unregister_class(Export3DB)
